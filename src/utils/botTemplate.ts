/**
 * Template complet du Bot Discord Zéléph avec :
 * - Commandes Slash /covoit et /sortie
 * - Boutons interactifs natifs [Je monte] / [Je participe] / [Se désister]
 * - Raccourci texte !covoit
 * - Serveur HTTP REST avec CORS :
 *   - GET /api/sync (lecture par la PWA)
 *   - POST /api/post-covoit (publication/mise à jour par le site avec vrais boutons)
 *   - POST /api/post-sortie (publication/mise à jour par le site avec vrais boutons)
 *   - Cache local persistent bot_cache.json
 */
export function getBotJsContent(): string {
  return `// ============================================================
